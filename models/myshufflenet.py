...
from torchvision.models.shufflenetv2 import load_state_dict_from_url
...
avg_pool2d = nn.AdaptiveAvgPool2d(1)
...
class ShuffleNetV2(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = self.conv1(x)
        if self.feature_map:
            fe_map.append(x.mean([2, 3]).cpu().detach())
